...
{
    /// <inheritdoc />
    public partial class M00firstmigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin@email.com.br", "Administrator", 0, "$2a$11$ZeYGi8/76lVrZ86LM3fDXOXwlFSzvhVPCf/9mUrb/jsfaFI2dYHdm" },
                    { 2, "cliente@email.com.br", "Cliente", 1, "$2a$11$5JEu7d/ID09PHFlrpSIllO9s1ObogPb7NvnS0xSsJZZBKjlIxeyEW" }
                });
